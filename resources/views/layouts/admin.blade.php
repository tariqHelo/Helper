...
<link href="{{ asset('metronic/assets/global/css/plugins-md.css') }}" rel="stylesheet" type="text/css"/>
<link href="{{ asset('metronic/assets/admin/layout2/css/layout.css') }}" rel="stylesheet" type="text/css"/>
